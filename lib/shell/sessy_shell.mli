...
val load_config_from_paths :
  string list -> Sessy_domain.config * string list

val load_sessions : Sessy_domain.config -> Sessy_domain.session list * string list

val spawn : Sessy_domain.launch_cmd -> (unit, [> `Exec_error of string ]) result
val exec_replace : Sessy_domain.launch_cmd -> unit
